    ...
    return (
        <section id="intro" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute inset-0 bg-[#ECE8E1]"></div>

                {/* Right Side - Matrix Image Background with Subtle Diagonal Cut */}
                <div
            ...
            <div className="w-full px-8 sm:px-12 lg:px-16 relative z-10">
                <div className="grid md:grid-cols-2 gap-32 items-center">
                    ...
                    >
                        ...
                        <h1 className="text-6xl md:text-8xl lg:text-9xl font-header font-bold uppercase leading-none mb-6">
                            <GlitchText className="text-black" enableOnHover={false} speed={0.8}>
                                {header.title.split(' ')[0]}
                            </GlitchText>
                            <br />
                            <GlitchText className="text-black" enableOnHover={false} speed={1}>
                        ...
                        <div className="flex flex-wrap gap-6">
                            ...
                            <a href={contact.links.Resume} target="_blank" rel="noopener noreferrer" className="px-10 py-4 border border-black text-black font-bold tracking-wider uppercase hover:bg-black hover:text-white transition-all duration-300 text-lg">
                                Download CV
                            </a>
                        </div>
                    </motion.div>
                    ...
                    >
                        {/* Empty space for balance - image is in background */}
                    </motion.div>
                </div>
            </div>
